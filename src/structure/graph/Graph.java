...
public class Graph {
     ...
     * @param bridges array of edges betwen graph a and graph b
     */
    ...
    protected void createStarGraph(Graph a, Graph b, Edge[] bridges, Integer copyCount) {
        ...
        for (int i = 0; i < a.edges.length; i++) {
            ...
            edges[edgesIndex++] = new Edge(vertices[e.getVertexStart().toInteger()],
                    vertices[e.getVertexEnd().toInteger()]);
        }
        ...
        for (int c = 0; c < copyCount; c++) {
            for (int i = 0; i < b.edges.length; i++) {
                Edge e = b.edges[i];
                edges[edgesIndex++] = new Edge(vertices[e.getVertexStart().toInteger() + aGraphShift + bGraphShift * c],
                        vertices[e.getVertexEnd().toInteger() + aGraphShift + bGraphShift * c]);
            }
